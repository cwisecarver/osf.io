    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emails', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, default=list, size=Node.load(None))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spam_status', models.IntegerField(blank=True, db_index=True, default=Node.load(None), null=True)),
                ('spam_pro_tip', models.CharField(blank=True, default=Node.load(None), max_length=200, null=True)),
                ('spam_data', osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict)),
                ('date_last_reported', osf.utils.fields.NonNaiveDateTimeField(blank=True, db_index=True, default=Node.load(None), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('errors', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), blank=True, default=list, size=Node.load(None))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copied_from', models.ForeignKey(blank=True, default=Node.load(None), null=True, on_delete=django.db.models.deletion.CASCADE, related_name='copy_of', to='osf.BaseFileNode')),
                ...
                ('parent', models.ForeignKey(blank=True, default=Node.load(None), null=True, on_delete=django.db.models.deletion.CASCADE, related_name='_children', to='osf.BaseFileNode')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ever_mentioned', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, default=list, size=Node.load(None))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', osf.utils.fields.NonNaiveDateTimeField(blank=True, default=Node.load(None), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scopes', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=128), blank=True, default=list, size=Node.load(None))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=Node.load(None), null=True, validators=[osf.models.validators.validate_location])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domains', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, db_index=True, null=True, size=Node.load(None))),
                ('email_domains', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, db_index=True, null=True, size=Node.load(None))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=128), blank=True, default=list, size=Node.load(None))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copyright_holders', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=256, null=True), blank=True, default=list, size=Node.load(None))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node_lineage', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=5), size=Node.load(None))),
        ...
        migrations.AddField(
            model_name='abstractnode',
            name='root',
            field=models.ForeignKey(blank=True, default=Node.load(None), null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='descendants', to='osf.AbstractNode'),
        ),
        migrations.AddField(
            model_name='abstractnode',
            name='tags',
