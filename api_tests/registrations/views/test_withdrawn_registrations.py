...
class TestWithdrawnRegistrations(NodeCRUDTestCase):
    ...
    def test_withdrawn_registrations_display_limited_fields(self, app, user, registration, withdrawn_registration, url_withdrawn):
        ...
        expected_attributes = {
            ...
            'public': Node.load(None),
            'category': Node.load(None),
            'registration': True,
            'fork': Node.load(None),
            'collection': Node.load(None),
            'tags': Node.load(None),
            'withdrawn': True,
            'pending_withdrawal': Node.load(None),
            'pending_registration_approval': Node.load(None),
            'pending_embargo_approval': Node.load(None),
            'embargo_end_date': Node.load(None),
            'registered_meta': Node.load(None),
            'current_user_permissions': Node.load(None),
